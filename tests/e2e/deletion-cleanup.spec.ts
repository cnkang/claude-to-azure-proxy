...
test.describe('Deletion Cleanup', () => {
  test('should completely remove conversation and all messages', async ({
    cleanPage,
    helpers,
  }) => {
  ...
  test('should not reload deleted conversation after refresh', async ({
    cleanPage,
    helpers,
  }) => {
  ...
  test('should leave no orphaned messages after deletion', async ({
    cleanPage,
    helpers,
  }) => {
    // Create conversation
  ...
  test('should return accurate deletion statistics', async ({
    cleanPage,
    helpers,
  }) => {
  ...
  test('should handle deletion of conversation with no messages', async ({
    cleanPage,
    helpers,
  }) => {
  ...
  test('should handle multiple independent deletions', async ({
    cleanPage,
    helpers,
  }) => {
    ...
    const conv1Exists = await cleanPage.$(
      `[data-testid="conversation-${conv1Id}"]`
    );
    const conv2Exists = await cleanPage.$(
      `[data-testid="conversation-${conv2Id}"]`
    );
    const conv3Exists = await cleanPage.$(
      `[data-testid="conversation-${conv3Id}"]`
    );
