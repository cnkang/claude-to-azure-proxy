...
const OptimizedMessageListComponent = forwardRef<OptimizedMessageListRef, OptimizedMessageListProps>(
  ({ className = '', autoScroll, autoScrollEnabled, ...props }, ref) => {
    const listHandleRef = useRef<MessageListHandle>(null);
    const containerRef = useRef<HTMLDivElement | null>(null);
    const registerContainer = useCallback((element: HTMLDivElement | null): void => {
