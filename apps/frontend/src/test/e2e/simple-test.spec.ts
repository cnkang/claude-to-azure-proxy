...
import { UIActions, TestSetup } from './helpers/index.js';
...
test.describe('E2E: Simple UI Test', () => {
  test('should create, rename, and delete a conversation', async ({ page }) => {
    ...
    console.log('Renamed conversation');
    
    // Verify title updated
    const titleElement = page.locator(`[data-testid="conversation-title-${conversationId}"]`);
