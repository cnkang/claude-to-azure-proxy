...
test.describe('Cross-Tab Synchronization', () => {
  ...
  test('should handle simultaneous updates with conflict resolution', async ({
    ...
    const update1Promise = helpers.updateConversationTitle(
      conversationId,
      title1
    );
    const update2Promise = helpers2.updateConversationTitle(
      conversationId,
      title2
    );
  ...
  test('should propagate conversation creation', async ({
    cleanPage,
    helpers,
  }) => {
    // Open tab 2 first
  ...
  test('should handle multiple rapid updates across tabs', async ({
    cleanPage,
    helpers,
  }) => {
    // Create a test conversation
  ...
  test('should maintain sync version consistency across multiple tabs', async ({
    cleanPage,
    helpers,
  }) => {
    // Create a test conversation
  ...
  test('should handle tab closing gracefully', async ({
    ...
    // Create a test conversation
    const conversationId = await helpers.createTestConversation('Test Title', [
      { role: 'user', content: 'Test' },
    ]);
    ...
    await helpers2.updateConversationTitle(
      conversationId,
  ...
  test('should not trigger storage events for same-tab updates', async ({
    cleanPage,
    helpers,
  }) => {
    // Create a test conversation
