 ...
 *
 * Use a single set of thresholds across environments so tests and runtime
 * share the same pressure semantics. This keeps memory pressure detection
 * consistent and avoids test-only behaviour.
 */
