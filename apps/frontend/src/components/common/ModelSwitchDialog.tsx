...
export const ModelSwitchDialog: React.FC<ModelSwitchDialogProps> = ({
    ...
    <div className="space-y-4">
      ...
      {validation.errors.length > 0 && (
        <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h4 className="font-semibold text-red-900 dark:text-red-100">{t('model.switch.errors')}</h4>
          </div>
      ...
      {validation.warnings.length > 0 && (
        <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <h4 className="font-semibold text-amber-900 dark:text-amber-100">{t('model.switch.warnings')}</h4>
          </div>
      ...
      {validation.suggestions.length > 0 && (
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-2">
            <span className="text-lg">💡</span>
            <h4 className="font-semibold text-blue-900 dark:text-blue-100">{t('model.switch.suggestions')}</h4>
          </div>
  ...
  const renderModelComparison = () => (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h4 className="font-semibold text-gray-900 dark:text-gray-100">{t('model.switch.comparison')}</h4>
      </div>
      ...
      <div className="grid grid-cols-[1fr,auto,1fr] gap-4 items-center">
        ...
        <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-xl border border-gray-200 dark:border-gray-700">
          <div className="flex flex-col gap-2 mb-3">
            <span className="text-xs text-gray-700 dark:text-gray-300 uppercase tracking-wider">{t('model.switch.current')}</span>
            <div className="flex items-center gap-2">
              <span className="font-semibold text-gray-900 dark:text-gray-100">{currentModel.name}</span>
          ...
          <div className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
            <div className="flex justify-between">
              ...
              <span className="font-medium">{currentModel.contextLimitFormatted}</span>
            </div>
            <div className="flex justify-between">
            ...
            <div className="flex justify-between">
              <span className="text-gray-700 dark:text-gray-300">{t('model.performance')}:</span>
              <span className={cn(
                "font-medium",
                currentModel.performanceRating === 'high' ? "text-green-700 dark:text-green-200" :
                currentModel.performanceRating === 'medium' ? "text-blue-700 dark:text-blue-200" :
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-xl border border-blue-200 dark:border-blue-800">
          <div className="flex flex-col gap-2 mb-3">
            <span className="text-xs text-blue-700 dark:text-blue-200 uppercase tracking-wider">{t('model.switch.target')}</span>
            <div className="flex items-center gap-2">
              <span className="font-semibold text-gray-900 dark:text-gray-100">{targetModel.name}</span>
          ...
          <div className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
            <div className="flex justify-between">
              <span className="text-gray-700 dark:text-gray-300">{t('model.contextLimit')}:</span>
              <span className="font-medium">{targetModel.contextLimitFormatted}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-700 dark:text-gray-300">{t('model.category')}:</span>
            ...
            <div className="flex justify-between">
              ...
              <span className={cn(
                "font-medium",
                targetModel.performanceRating === 'high' ? "text-green-700 dark:text-green-200" :
                targetModel.performanceRating === 'medium' ? "text-blue-700 dark:text-blue-200" :
                "text-amber-600 dark:text-amber-400"
              )}>
  ...
  const renderContextInfo = () => (
    <div className="space-y-4">
      <h4 className="font-semibold text-gray-900 dark:text-gray-100">{t('model.switch.contextInfo')}</h4>
  ...
  const renderOptions = () => (
    <div className="space-y-4">
      <h4 className="font-semibold text-gray-900 dark:text-gray-100">{t('model.switch.options')}</h4>
