export default {
  ...
  sidebar: {
    ...
    titleTooLong: 'Title too long (max 100 characters)',
    close: 'Close sidebar',
    session: 'Session',
    settings: 'Settings',
    help: 'Help',
  ...
  chat: {
    ...
    keywordNavigation: 'Keyword navigation',
    occurrenceCounter: '{{current}} of {{total}}',
    previousOccurrence: 'Previous occurrence',
    nextOccurrence: 'Next occurrence',
    navigatedToOccurrence: 'Navigated to occurrence {{current}} of {{total}}',
    scrolledToMatch: 'Scrolled to search match',
  },
  fileUpload: {
  ...
  search: {
    ...
    suggestion1: 'Try different keywords',
    suggestion2: 'Check your spelling',
    suggestion3: 'Use fewer or more general terms',
    suggestion4: 'Search for partial words',
    ...
    highlightCount: '{{count}} occurrence',
    highlightCount_plural: '{{count}} occurrences',
    moreMatches: '+{{count}} more match',
    moreMatches_plural: '+{{count}} more matches',
