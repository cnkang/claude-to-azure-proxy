...
import PerformanceAlertSystem, { type AlertConfig, type PerformanceAlert } from '../../src/monitoring/performance-alerts.js';
...
describe('Performance Alert System', () => {
  ...
  describe('Response Time Alerts', () => {
    ...
    it('should trigger critical alert for very slow response time', async () => {
      ...
      const criticalAlert = alertsReceived.find(alert => alert.level === 'critical');
  ...
  describe('Error Rate Alerts', () => {
    it('should trigger alert for high error rate', async () => {
      ...
      const errorRateAlerts = alertsReceived.filter(alert => alert.metric === 'error_rate');
  ...
  describe('Metrics Export', () => {
    it('should export metrics to file', async () => {
      ...
      await expect(alertSystem.exportMetrics(exportPath)).resolves.not.toThrow();
