...
import type { HealthCheckResult, RequestWithCorrelationId, ServerConfig } from '../types/index.js';
import { logger } from '../middleware/logging.js';
import { healthMonitor } from '../monitoring/health-monitor.js';
import { circuitBreakerRegistry, retryStrategyRegistry, gracefulDegradationManager } from '../resilience/index.js';
...
const checkAzureOpenAI = async (config: ServerConfig): Promise<{
